...
//        delegate?.sendWeekDataPAss?(arrList: dayView)
       // delegate?.sendWeekDataPAss?(arrList: dayView.weekView.dayViews!)
...
//    public func presentWeeekData(_ dayView: [CVCalendarDayView]) {
//    }
}
...
extension CVCalendarView {
    ...
    public func changeMode(_ mode: CalendarMode, completion: @escaping () -> () = {}) {
        ...
        switch mode {
        case .weekView:
            contentController.updateHeight(55, animated: true)
